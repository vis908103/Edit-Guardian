...
from config import  MONGO_URI, DB_NAME, TELEGRAM_TOKEN, OWNER_ID, SUDO_ID, BOT_NAME, SUPPORT_ID #API_ID, API_HASH

app = Client("AutoDelete", bot_token=TELEGRAM_TOKEN)
